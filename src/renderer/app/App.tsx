...
export function App() {
  ...
  useEffect(() => {
    ...
    panel.innerHTML = `
      ...
      <label>FX Preset<select data-fx="preset"><option value="stardust-stream">Stardust Energy Stream</option><option value="cinematic-orbit">Cinematic Orbit</option><option value="smoke-ember">Smoke & Ember</option><option value="golden-dust">Golden Dust</option><option value="neon-ribbon">Neon Ribbon</option><option value="pink-nebula">Pink Nebula 🌸</option><option value="sparkle-burst">Sparkle Burst ✨</option><option value="firework-streaks">Firework Streaks 🎆</option><option value="purple-vortex">Purple Vortex 🌀</option><option value="pink-nebula">Pink Nebula 🌸</option><option value="sparkle-burst">Sparkle Burst ✨</option><option value="firework-streaks">Firework Streaks 🎆</option><option value="purple-vortex">Purple Vortex 🌀</option><option value="ice-crystal">Ice Crystal ❄️</option><option value="fire-dance">Fire Dance 🔥</option><option value="dreamy-pastel">Dreamy Pastel 🎨</option><option value="fine-dust">Fine Dust ✨</option><option value="minimal">Minimal</option></select></label>
      ...
      <div class="fx-section"><h4 class="fx-section-title">🎨 General</h4>
        <label class="range-label">FX Preset <select data-fx="preset"><option value="stardust-stream">Stardust Stream</option><option value="cinematic-orbit">Cinematic Orbit</option><option value="smoke-ember">Smoke & Ember</option><option value="golden-dust">Golden Dust</option><option value="neon-ribbon">Neon Ribbon</option><option value="pink-nebula">Pink Nebula 🌸</option><option value="sparkle-burst">Sparkle Burst ✨</option><option value="firework-streaks">Firework Streaks 🎆</option><option value="purple-vortex">Purple Vortex 🌀</option><option value="ice-crystal">Ice Crystal ❄️</option><option value="fire-dance">Fire Dance 🔥</option><option value="dreamy-pastel">Dreamy Pastel 🎨</option><option value="fine-dust">Fine Dust ✨</option><option value="minimal">Minimal</option></select></label>
        <label class="toggle-row"><span>Enable Visual FX</span><input data-fx="enabled" type="checkbox"></label>
      </div>
