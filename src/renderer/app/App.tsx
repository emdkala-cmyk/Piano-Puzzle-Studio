...
export function App() {
  ...
  useEffect(() => { assetRef.current = asset; geometryRef.current = geometry; mappingRef.current = mapping; timingRef.current = timingSettings; expressionRef.current = expressionSettings; }, [asset, geometry, mapping, timingSettings, expressionSettings]);
  ...
  useEffect(() => {
    if (mapping && geometry) {
      ...
      const timeline = engineRef.current.rebuild({ mapping, pieces: geometry.pieces, timing: timingSettings, expression: expressionResult });
  ...
  }, [mapping, geometry, timingSettings, expressionSettings, midi]);
