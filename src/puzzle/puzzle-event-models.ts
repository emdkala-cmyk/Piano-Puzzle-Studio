...
export interface MidiMappingConfig { enabled: boolean; sourceAssetId?: string; calibrationId?: string; mappingMode: PieceMappingMode; outOfRangePolicy: OutOfRangePolicy; chordWindowMs: number; showDebugMarkers: boolean; showAssignmentLines: boolean }
