...
export const DEFAULT_VISUAL_FX_CONFIG: VisualFxConfig = {
  ...
  smokeDensity: 0.03,
  smokeLayerCount: 1,
  smokeEmissionIntervalMs: 80,
  smokeFrameBudget: 10,
  particleFrameBudget: 60,
  bassThreshold: 48,
  highThreshold: 84,
  particleSize: 0.4,
  pathCurvature: 0.3,
...
pathStyle: "scattered" as FxPathStyle,
  particleMotion: "linear" as FxParticleMotion,
  customColor: "#ff6600",
  keyboardGlowEnabled: true,
  keyboardGlowIntensity: 0.45,
  lightTrailEnabled: false,
  lightTrailWidth: 8,
  lightTrailGlowLayers: 1,
  lightTrailLifetimeMs: 400,
  lightTrailCoreBrightness: 0.7,
  lockFadeDurationMs: 180,
  trailFadeSpeed: 0.25,
