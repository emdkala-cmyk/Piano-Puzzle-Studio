...
const PRESET_TUNING: Record<VisualFxPreset, FxPresetTuning> = {
  "cinematic-orbit": {
    ...
    smokeMultiplier: 1.15,
    sparkleMultiplier: 1.25,
    particleScale: 1.15,
    curveMultiplier: 1.15,
    swirl: 0.9,
    glowMultiplier: 1.2,
    smokeCoreScale: 0.78,
    smokeVolumeScale: 1.08,
    smokeResidueScale: 1.36,
    smokeDrag: 1,
    smokeTurbulence: 1,
    bassSmokeMultiplier: 1.18,
    highSmokeMultiplier: 0.72,
    highShimmerMultiplier: 0.9
  },
  "smoke-ember": {
    trailMultiplier: 0.9,
    smokeMultiplier: 1.8,
    sparkleMultiplier: 0.8,
    particleScale: 1.2,
    curveMultiplier: 0.8,
    swirl: 0.55,
    glowMultiplier: 1,
    smokeCoreScale: 0.86,
    smokeVolumeScale: 1.16,
    smokeResidueScale: 1.42,
    smokeDrag: 1.2,
    smokeTurbulence: 0.8,
    bassSmokeMultiplier: 1.3,
    highSmokeMultiplier: 0.64,
    highShimmerMultiplier: 0.75
  },
  "golden-dust": {
